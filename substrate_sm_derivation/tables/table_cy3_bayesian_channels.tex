...
\hline
$\sigma$-channel conservative (full $20{+}20$; \emph{excluded from BF}) & Welch $t$ on $\sigma$-distribution & --- & $3.99\sigma$ (pct CI $[3.29, 10.64]$, straddles $5\sigma$) \\
$\sigma$-channel strict-converged (conditional; \emph{excluded from BF}) & Welch $t$ on $\sigma$-distribution & --- & $6.92\sigma$ (BCa $[5.30, 9.04]$; $4/20$ Schoen seeds dropped from upper tail) \\
\end{tabular}
\end{ruledtabular}
\end{table*}
