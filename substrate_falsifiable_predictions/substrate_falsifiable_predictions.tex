...
\href{https://github.com/gable-digital/papers/blob/v2026-05-05-cross-anchor/substrate_falsifiable_predictions/cross_anchor_full.csv}{\texttt{cross\_anchor\_full.csv}}
(permanent reference, pinned to git tag
\texttt{v2026-05-05-cross-anchor}).
